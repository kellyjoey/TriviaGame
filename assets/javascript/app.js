...
var quiz = [
    ...
    {
    	"question"		: 	"One of the following is a plot from an actual 50s Batman comic.  One of these actually happened.  Which is it?", 
    ...
    {
    	"question"		:   "During the 1950s, Batman was joined in his war on crime by several allies.  Which of these was NOT among them?",
    ...
    {
    	"question"		: 	"Which of the following exclamations was NOT heard on the 1966-1968 Batman TV show?",
    ...
    {
    	"question"		:   "In 1984, Dick Grayson gave up the role of Robin to assume his own independent crime-fighting identity?  Which name did he choose?", 
    ...
    {
    	"question"		:   "In 1988, the fate of Jason Todd, the second Robin, the Boy-Wonder, was left up to a call-in vote where readers could call up to decide if this kid lived or died.  Readers hungering for the kid’s death won the day, but how close was the final vote?  How many votes separated it?",
    ...
    {
    	"question"		:   "In 2005, Jason Todd, the second Robin, returned from the dead after 17 years.  How did he accomplish this", 
...
$(".choice").on("click", function(){
	...
	if ((this.value)===(quiz[i].answer)){
		...
		$("#explanation").append(quiz[i].explanation);
